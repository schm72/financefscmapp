...
com.springer.financefscmapp.util.Controller.extend("com.springer.financefscmapp.view.OI_Saved_Master", {
	...
	onInit: function() {
		...
		this.getView().byId("list").attachEventOnce("updateFinished", function() {
			...
			oEventBus.publish("OI_Saved_Master", "InitialLoadFinished", {
				oListItem: this.getView().byId("list").getItems()[0]
			});
		}, this);

		oEventBus.subscribe("OI_Saved_Detail", "TabChanged", this.onDetailTabChanged, this);
		...
		oEventBus.subscribe("OI_Saved_Detail", "Changed", this.onDetailChanged, this);
		oEventBus.subscribe("OI_Saved_Detail", "NotFound", this.onNotFound, this);
	},
