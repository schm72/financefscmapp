...
com.springer.springerfscmapp.util.Controller.extend("com.springer.springerfscmapp.view.SecondLevel.BPInvoiceDetail", {
	...
	onDetailSelect: function(oEvent) {
		...
		switch (key) {
			case "Details":
				...
				break;
			case "Attached":
				var sAggregationPath = this.sEntityPath + "/ATTACHMENT_INFO_LISTSet";
				var oTable = this.getView().byId("attachmentList");
				oTable.bindAggregation("items", sAggregationPath, sap.ui.xmlfragment(
					"com.springer.springerfscmapp.view.HelpDialogs.DetailInvoiceAttach", this));
