...
com.springer.financefscmapp.util.Controller.extend("com.springer.financefscmapp.view.SecondLevel.FSCM_partner_list_Master", {
	...
	onInit: function() {
		...
		this.getView().byId("list").attachEventOnce("updateFinished", function() {
			...
			oEventBus.publish("FSCM_partner_list_Master", "InitialLoadFinished", {
				oListItem: this.getView().byId("list").getItems()[0]
			});
		}, this);

		oEventBus.subscribe("FSCM_partner_list_Detail", "TabChanged", this.onDetailTabChanged, this);
		...
		oEventBus.subscribe("FSCM_partner_list_Detail", "Changed", this.onDetailChanged, this);
		oEventBus.subscribe("FSCM_partner_list_Detail", "NotFound", this.onNotFound, this);
	},
	...
	onRouteMatched: function(oEvent) {
		...
		if (sName !== "_FSCM_partner_list_Master") {
			return;
		}
		//Load the detail view in desktop
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "com.springer.financefscmapp.view.SecondLevel.FSCM_partner_list_Detail",
			targetViewType: "XML"
		});
	...
	showDetail: function(oItem) {
		...
		this.getRouter().navTo("_FSCM_partner_list_Detail", {
			from: "_FSCM_partner_list_Master",
