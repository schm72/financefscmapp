...
com.springer.springerfscmapp.util.Controller.extend("com.springer.springerfscmapp.view.SecondLevel.BPInvoiceList", {
	...
	onRouteMatched: function(evt) {
		...
		var sAggregationPath = "/" + this.currentEntity + "/OPEN_ITEM_BP_DETAILVIEWSet";
	...
	onAfterShow: function() {
		...
		if (contextModel.Partner !== "") {
			this.byId("invoiceOverviewBP").setTitle("Invoices BP " + contextModel.partner);
		}
	},
	...
	handleSelectionChange: function(oEvent) {
		...
		var bReplace = jQuery.device.is.phone ? false : true;
		this.getRouter().navTo("_BPInvoiceDetail", {
			from: "_BPInvoiceList",
