...
com.springer.financefscmapp.util.Controller.extend("com.springer.financefscmapp.view.A1_FirstVisitCheck", {
	...
	onInit: function() {
		...
		var vDevice;
		switch (true) {
			case jQuery.device.is.desktop:
				vDevice = "Desktop";
				break;
			case jQuery.device.is.android_phone:
				vDevice = "Android";
				break;
			case jQuery.device.is.android_tablet:
				vDevice = "Android Tablet";
				break;
			case jQuery.device.is.ipad:
				vDevice = "iPhone Tablet";
				break;
			case jQuery.device.is.iphone:
				vDevice = "iPhone";
				break;
			case jQuery.device.is.phone:
				vDevice = "Phone";
				break;
			default:
				vDevice = "undefined";
	...
	chooseCollArea: function(addText) {
		...
		var CustomText = "Please choose your collecting areas";
		if (addText === true) {
	...
	onlineModeNew: function() {
		...
		var textArea = this.getView().byId("ContextText");
		textArea.setVisible(true);
		textArea.setValue("It is the first time this user enters the App.");
