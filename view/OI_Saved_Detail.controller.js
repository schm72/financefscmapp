...
com.springer.financefscmapp.util.Controller.extend("com.springer.financefscmapp.view.OI_Saved_Detail", {
	...
	onInit : function() {
		...
		if(sap.ui.Device.system.phone) {
			...
			this.getEventBus().subscribe("OI_Saved_Master", "InitialLoadFinished", this.onMasterLoaded, this);
		} 
	...
	onRouteMatched : function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function () {
			...
			if (oParameters.name !== "_OI_Saved_Detail") { 
				return;
			}
...
/*
			...
			this.getEventBus().publish("OI_Saved_Detail", "TabChanged", { sTabKey : sTabKey });
...
*/
	...
	fireDetailChanged : function (sEntityPath) {
		this.getEventBus().publish("OI_Saved_Detail", "Changed", { sEntityPath : sEntityPath });
	},

	fireDetailNotFound : function () {
		this.getEventBus().publish("OI_Saved_Detail", "NotFound");
	},
...
/*
		sap.ui.core.UIComponent.getRouterFor(this).navTo("_OI_Saved_Detail",{
...
>>>>>>> 2373059b0ad169526e3768e6323cb0459202d134
	...
	onNavBack : function() {
		...
		this.getRouter().myNavBack("OI_Saved_Master");
	}
});
