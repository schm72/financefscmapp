...
com.springer.springerfscmapp.util.Controller.extend("com.springer.springerfscmapp.view.OI_Overview_Master", {
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.springer.springerfscmapp.view.OI_Overview_Detail",
			targetViewType: "XML"
		});
