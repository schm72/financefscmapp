			...
			routes : [
                ...
                },
				{
                    ...
                    subroutes: [
                        {
                            pattern : "OIO",
                            name : "_FSCM_partner_list_Master",
                            view : "SecondLevel/FSCM_partner_list_Master",
                            targetAggregation : "masterPages",
                            targetControl : "idSplitAppControl",
                            viewLevel: 2,
                            subroutes : [
                                {
                                    pattern : "OIO/{entity}/:tab:",
                                    name : "_FSCM_partner_list_Detail",
                                    view : "SecondLevel/FSCM_partner_list_Detail",
                                    targetAggregation: "detailPages",
                                    viewLevel: 3
                                }
                            ]
                ...
                },
				{
					...
					subroutes: [
                        {
                            pattern : "OIS",
                            name : "_FSCM_partner_list_Master_SVD",
                            view : "SecondLevel/FSCM_partner_list_Master_SVD",
                            targetAggregation : "masterPages",
                            targetControl : "idSplitAppControl",
                            viewLevel: 2,
                            subroutes : [
                                {
                                    ...
                                    name : "_FSCM_partner_list_Detail_SVD",
                                    view : "SecondLevel/FSCM_partner_list_Detail_SVD",
                                    targetAggregation: "detailPages",
                                    viewLevel: 3
                                }
                            ]
				...
				{
					pattern: "OIOVL_SVD",
					name: "_OpenItemsOverViewList_SVD",
					view: "SecondLevel/OpenItemsOverViewList_SVD",
					targetAggregation: "pages",
					targetControl: "idAppControl",
					viewLevel: 1,
                    subroutes : [
                        {
                            pattern : "OIOVL_SVD/{entity}",
                            name : "_BPInvoiceList_SVD",
                            view : "SecondLevel/BPInvoiceList_SVD",
                            targetAggregation: "pages",
                            viewLevel: 2,
		                    subroutes : [
		                        {
		                            pattern : "OIOVL_SVD/{entity}/{docid}",
		                            name : "_BPInvoiceDetail_SVD",
		                            view : "SecondLevel/BPInvoiceDetail_SVD",
		                            targetAggregation: "pages",
		                            viewLevel: 3
		                        }
		                   ]
